...
object AppThemeUtils {
    ...
    fun setMode(context: Context, mode: Int) {
        context.getDefaultSharedPreferences().commitEdit { putInt(KEY_THEME_MODE, mode) }
    }
    ...
    fun setEnableMonetColor(context: Context, enable: Boolean) {
        context.getDefaultSharedPreferences().commitEdit { putBoolean(KEY_MONET_COLOR, enable) }
    }
}