...
<p align="center">
  Lyricon is a system-level module built on the LSPosed framework, designed to seamlessly integrate real-time lyrics directly into your status bar.
</p>
...
- 🎤 **Rich Display**: Supports syllable-by-syllable scrolling, lyric translations, and duet
  indicators.
- 🧩 **Modular Design**: Limitless expansion of lyric sources via independent plugins.
- 🎨 **Customization**: Deep system integration with granular control over fonts, logos, positioning,
  and animations.
...
5. **Customize**: Open the Lyricon app to adjust the anchor position, width, and visual style in
   real-time.
6. **Enjoy**: Play some music and enjoy the vibes.
...
* [ConePlayer (光锥音乐)](https://coneplayer.trantor.ink/) - An elegant local music player with a
